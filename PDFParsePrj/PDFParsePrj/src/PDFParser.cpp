...
{
//    const char *fileName = "/Users/apple/Documents/workspace/PDFParsePrj/PDFParsePrj/pdf_reference_1-7.pdf";
//        const char *fileName= "file:///Users/apple/Documents/workspace/PDFParsePrj/Build/Products/Debug/PDFParsePrj.app/QPlayWidget.h";
//    const char *fileName =
//    FILE *m_fd = fopen(fileName, "rb");
//    if(m_fd==NULL) {
//        printf("fail, errorno=%d", errno);
//        fclose(m_fd);
//    } else {
//        printf("success, errorno=%d", errno);
//    }
//    return 1;
//    
	int i;
